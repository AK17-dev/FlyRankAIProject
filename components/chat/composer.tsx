    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-2xl items-end gap-2">
        <textarea
          ...
          aria-label="Message"
          className="thin-scrollbar min-h-11 flex-1 resize-none overflow-y-auto rounded-2xl border border-border bg-card px-4 py-2.5 text-base leading-6 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-60"
        />
